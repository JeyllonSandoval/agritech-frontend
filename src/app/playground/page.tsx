...
export default function Playground() {
    return (
        <ProtectedRoute>
            <div className="flex flex-col items-center justify-center p-4 sm:p-6 md:p-8 bg-gradient-to-br from-green-950/90 via-black to-green-950/90">
                <div className="w-full max-w-4xl min-h-screen space-y-4 sm:space-y-6 md:space-y-8">
                    ...
                    <div className="fixed bottom-0 left-0 right-0 p-4 text-center bg-white/5 backdrop-blur-sm border-t border-white/10">
